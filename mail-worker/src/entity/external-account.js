...
export const externalAccount = sqliteTable('external_account', {
	...
	originalEmail: text('original_email').default('').notNull(),
	...
	microsoftClientId: text('microsoft_client_id').default('').notNull(),
	microsoftRefreshToken: text('microsoft_refresh_token').default('').notNull(),
	microsoftDeltaLink: text('microsoft_delta_link').default('').notNull(),
